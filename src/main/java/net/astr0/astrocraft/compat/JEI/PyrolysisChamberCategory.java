...
import net.astr0.astrocraft.recipe.PyrolysisChamberRecipe;
...
public class PyrolysisChamberCategory implements IRecipeCategory<PyrolysisChamberRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(Astrocraft.MODID, "pyro");
    ...
    public static final RecipeType<PyrolysisChamberRecipe> PYROLYSIS_CHAMBER_TYPE =
            new RecipeType<>(UID, PyrolysisChamberRecipe.class);

    private final IDrawable background;
    private final IDrawable icon;
    private final IDrawableAnimated arrow;

    public PyrolysisChamberCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 86);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.PYROLYSIS_CHAMBER.get()));
    ...
    @Override
    public RecipeType<PyrolysisChamberRecipe> getRecipeType() {
        return PYROLYSIS_CHAMBER_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.literal("Pyrolysis Chamber");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, PyrolysisChamberRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(PyrolysisChamberRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
