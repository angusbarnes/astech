package net.astr0.astrocraft.block.EUVMachine;
...
public class EUVMachineMenu extends AbstractContainerMenu {
    public final EUVMachineBlockEntity blockEntity;
    ...
    public EUVMachineMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.EUV_MACHINE_MENU.get(), pContainerId);
        ...
        this.blockEntity.getInputItemHandler().ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 81, 47));
        });

        this.blockEntity.getOutputItemHandler().ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 111, 34) {
                @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.EUV_MACHINE.get());
    }
