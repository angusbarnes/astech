package net.astr0.astrocraft.block.ReactionChamber;
...
public class ChemicalReactorScreen extends AsTechGuiScreen<ChemicalReactorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Astrocraft.MODID, "textures/gui/chemical_reactor.png");
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        pGuiGraphics.drawString(this.font, Component.literal("Chemical Reactor"), 5, 5, GraphicsUtils.DEFAULT_INVENTORY_TEXT_COLOR, false);
    }
