...
public abstract class AsTechGuiElement {
    ...
    public abstract boolean handleClick(ItemStack carried, int mouseButton, boolean isScreenLocked);
    ...
    public abstract boolean isMouseInBounds(double mouseX, double mouseY);
}
