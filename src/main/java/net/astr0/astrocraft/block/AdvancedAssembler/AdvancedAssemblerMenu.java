package net.astr0.astrocraft.block.AdvancedAssembler;
...
public class AdvancedAssemblerMenu extends AbstractContainerMenu {
    public final AdvancedAssemblerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public AdvancedAssemblerMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public AdvancedAssemblerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ADVANCED_ASSEMBLER_MENU.get(), pContainerId);
        ...
        blockEntity = ((AdvancedAssemblerBlockEntity) entity);
        ...
        this.blockEntity.getInputItemHandler().ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 36, 26));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 54, 26));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 72, 26));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 36, 44));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 54, 44));
        });
    ...
    private static final int TE_INVENTORY_INPUT_COUNT = 5;
    @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ADVANCED_ASSEMBLER.get());
    }
