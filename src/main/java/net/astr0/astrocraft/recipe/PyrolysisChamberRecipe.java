 ...
 */
public class PyrolysisChamberRecipe extends AsTechRecipeBase {
    ...
    public PyrolysisChamberRecipe(ResourceLocation id, FluidIngredient input1, FluidStack outputFluid1, FluidStack outputFluid2, int processingTime) {
        super(id);
        this.input1 = input1;
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.PYROLYSIS_CHAMBER_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return ModRecipes.PYROLYSIS_CHAMBER_RECIPE_TYPE.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<PyrolysisChamberRecipe> {
        ...
        public PyrolysisChamberRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new PyrolysisChamberRecipe(recipeId, input1, output1, output2, processingTime);
        }

        @Nullable
        @Override
        public PyrolysisChamberRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            ...
            return new PyrolysisChamberRecipe(recipeId, input1, outputFluid1, outputFluid2, processingTime);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buffer, PyrolysisChamberRecipe recipe) {
            recipe.write(buffer);
        }
    }
}
