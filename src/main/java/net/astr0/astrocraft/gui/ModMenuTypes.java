...
import net.astr0.astrocraft.block.AdvancedAssembler.AdvancedAssemblerMenu;
import net.astr0.astrocraft.block.Assembler.AssemblerMenu;
import net.astr0.astrocraft.block.ChemicalMixer.ChemicalMixerMenu;
import net.astr0.astrocraft.block.CoolantBlock.CoolantBlockMenu;
import net.astr0.astrocraft.block.EUVMachine.EUVMachineMenu;
import net.astr0.astrocraft.block.ElectrolyticSeperator.ElectrolyticSeperatorMenu;
import net.astr0.astrocraft.block.GemPolisher.GemPolishingStationMenu;
import net.astr0.astrocraft.block.PyrolysisChamber.PyrolysisChamberMenu;
import net.astr0.astrocraft.block.ReactionChamber.ChemicalReactorMenu;
import net.astr0.astrocraft.item.CableToolMenu;
