...
public static final RegistryObject<Block> CHLORINE_ORE = registerBlock("chlorine_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_CHLORINE_ORE = registerBlock("deepslate_chlorine_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> NITROGEN_ORE = registerBlock("nitrogen_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_NITROGEN_ORE = registerBlock("deepslate_nitrogen_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> BROMINE_ORE = registerBlock("bromine_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_BROMINE_ORE = registerBlock("deepslate_bromine_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> ADAMANTIUM_ORE = registerBlock("adamantium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_ADAMANTIUM_ORE = registerBlock("deepslate_adamantium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> CARBONADIUM_ORE = registerBlock("carbonadium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_CARBONADIUM_ORE = registerBlock("deepslate_carbonadium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> RADON_ORE = registerBlock("radon_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_RADON_ORE = registerBlock("deepslate_radon_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> NEON_ORE = registerBlock("neon_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_NEON_ORE = registerBlock("deepslate_neon_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> XENON_ORE = registerBlock("xenon_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_XENON_ORE = registerBlock("deepslate_xenon_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> STIPNICIUM_ORE = registerBlock("stipnicium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_STIPNICIUM_ORE = registerBlock("deepslate_stipnicium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> SODIUM_ORE = registerBlock("sodium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_SODIUM_ORE = registerBlock("deepslate_sodium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> POTASSIUM_ORE = registerBlock("potassium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_POTASSIUM_ORE = registerBlock("deepslate_potassium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> HELIUM_ORE = registerBlock("helium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_HELIUM_ORE = registerBlock("deepslate_helium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> KRYPTON_ORE = registerBlock("krypton_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_KRYPTON_ORE = registerBlock("deepslate_krypton_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
...
public static final RegistryObject<Block> IUMIUM_ORE = registerBlock("iumium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
public static final RegistryObject<Block> DEEPSLATE_IUMIUM_ORE = registerBlock("deepslate_iumium_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)));
