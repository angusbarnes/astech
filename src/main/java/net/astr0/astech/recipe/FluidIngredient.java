...
public class FluidIngredient extends Ingredient {
    ...
    protected FluidIngredient(List<Fluid> fluids, int amount, ResourceLocation fluidId, TagKey<Fluid> fluidTagKey, CompoundTag nbt, boolean fuzzyNBT) {
        ...
        if(fluids != null) {
            LogUtils.getLogger().info("RECIPE_DEBUG: new fluid ingredient created: {}, {}, {}", fluids.isEmpty() ? "null" : fluids.get(0), fluidTagKey, nbt);
        }
    }
...
//    }
    ...
    public static class Serializer implements IIngredientSerializer<FluidIngredient> {
        ...
        public static final ResourceLocation ID = new ResourceLocation("astech:fluid");
        ...
        public FluidIngredient parse(JsonObject json) {
            ...
            LogUtils.getLogger().info("RECIPE_DEBUG: Created fluidstack of: {}, {}", result.fluidId, result.amount);
            return result;
        }
