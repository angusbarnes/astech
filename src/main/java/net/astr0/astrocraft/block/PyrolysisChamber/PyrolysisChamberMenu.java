package net.astr0.astrocraft.block.PyrolysisChamber;
...
public class PyrolysisChamberMenu extends AbstractContainerMenu {
    public final PyrolysisChamberBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public PyrolysisChamberMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public PyrolysisChamberMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.PYROLYSIS_CHAMBER_MENU.get(), pContainerId);
        ...
        blockEntity = ((PyrolysisChamberBlockEntity) entity);
    ...
    private static final int TE_INVENTORY_INPUT_COUNT = 0;
    @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.PYROLYSIS_CHAMBER.get());
    }
