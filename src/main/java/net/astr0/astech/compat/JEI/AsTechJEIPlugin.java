...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_ANILINE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used in the production of dyes, rubber and chemicals."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_AZOTH.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("A fictional chemical often referenced in alchemical texts and stories."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_BUTANE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used as a fuel in lighters and portable stoves."));
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_CARBON_TETRACHLORIDE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Once used in fire extinguishers and as a cleaning agent."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_DIMETHYL_ETHER.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used as a propellant in aerosol products. Very flammable"));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_ETHANOL.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Commonly known as alcohol, used in beverages and as a fuel."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_HYDROCARBONIC_BROTH.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("A mixture of hydrocarbons often used as a solvent."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_PERCHLOROETHYLENE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Commonly used in dry cleaning."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_PROPANE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used as a fuel for heating, cooking and in engines."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_SODIUM_BICARBONATE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Commonly known as baking soda used in cooking and cleaning."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_THIONYL_CHLORIDE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used in the synthesis of acyl chlorides and in lithium batteries."));
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_TITANIUM_TETRACHLORIDE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used in the production of titanium metal and in smoke screens."));
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_TOLUENE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("A solvent used in paint thinners and adhesives."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_VINYL_CHLORIDE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used in the production of polyvinyl chloride (PVC)."));
...
registration.addIngredientInfo(new FluidStack(ModFluids.FLOWING_XYLENE.get().getSource(), 1000), ForgeTypes.FLUID_STACK, Component.literal("Used as a solvent in the printing, rubber and leather industries."));
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        ...
        registration.addRecipeClickArea(EUVMachineScreen.class, 69, 40, 28, 8,
                EUVMachineCategory.EUV_MACHINE_TYPE);
    }
